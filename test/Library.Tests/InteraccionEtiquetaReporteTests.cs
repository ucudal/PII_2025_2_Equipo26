...
namespace Library.Tests
{
    ...
    public class InteraccionEtiquetaReporteTests
    {
        ...
        public void TestRegistrarVentaGeneralYReporte()
        {
            ...
            this._fachada.RegistrarVenta("Producto A", 100, fecha1);
            this._fachada.RegistrarVenta("Producto B", 50, fecha2);
            this._fachada.RegistrarVenta("Producto C", 200, fecha3); 
        ...
        public void TestRegistrarVentaAsignadaACliente()
        {
            ...
            this._fachada.RegistrarVenta(this.clienteId, "Servicio Premium", 1500);
            this._fachada.RegistrarVenta(this.clienteId, "Soporte", 500);
