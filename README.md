...
| Como usuario quiero modificar la información de un cliente existente, para mantenerla actualizada.                       | `!crear_cliente`<br>`!modificar_cliente`                                            | `!crear_cliente "Juan" "Perez" 099123456 juan@mail.com`<br>`!modificar_cliente 1 "Juan" "Pablo"`                                                                                                             |
...
| Como usuario quiero ver los clientes con ventas de cierto producto o servicio.| `!crear_cliente`<br>`!registrar_venta`<br>`!ver_ventas`| `!crear_cliente "Prueba" "Buscador" 092222333 dash@mail.com`<br>`!registrar_venta 1 tostadora 500 01/02/2006`<br>`!ver_ventas Tostadora`                                                                      | 
---
...
* Rama creada por Anthony Viera para la defensa del proyecto, se agrega el comand: "VerVentasProdCommand", el metodo "BuscarVentasProducto" y un test al final de FachadaTest : "BuscarVentasProducto_DeberiaRetornarClientesQueCompraronProducto"
---
