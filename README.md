...
| Comando quiero ver los clientes con ventas dentro de un cierto rango de montos                                           | `!crear_cliente`<br>`!registrar_venta`<br>`!defensa_cliente_conventas`                                       | ` !crear_cliente "Comprador" "Total" 091111222 total@mail.com`<br>`!registrar_venta 1 "Item 1" 950`<br>`!defensa_cliente_conventas 900 1000`|
---
